...
<nav class="navbar navbar-expand-lg navbar-light bg-info">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="img/logo/logo1.jpg" class="logo"></a>
...
<div class="row">
    <div class="col-md-10">
        ...
        <div class="row">
            ...
            <div class="card">
  <img src="img/product/pic1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    ...
    <a href="#" class="btn btn-secondary">View more</a>
            ...
            <div class="col-md-4 mb-2">
            <div class="card">
  <img src="img/product/pic2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-info">Add to cart</a>
  ...
  <div class="card-body">
    ...
    <a href="#" class="btn btn-secondary">View more</a>
            ...
            <div class="col-md-4 mb-2">
            <div class="card">
  <img src="img/product/pic3.jpg" class="card-img-top" >
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-info">Add to cart</a>
    <a href="#" class="btn btn-secondary">View more</a>
                ...
                <div class="col-md-4 mb-2">
            <div class="card">
  <img src="img/product/img-1.jpg" class="card-img-top" >
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-info">Add to cart</a>
    <a href="#" class="btn btn-secondary">View more</a>
                ...
                <div class="col-md-4 mb-2">
            <div class="card">
  <img src="img/product/img-2.jpg" class="card-img-top" >
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-info">Add to cart</a>
